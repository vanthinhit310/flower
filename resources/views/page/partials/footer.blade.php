    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="widget">
          ...
          <address>
            <strong>{{config('general.site_name')}}</strong><br>
            {{ config('general.address') }}<br>
            <abbr title="Phone">Phone:</abbr> {{ config('general.phone') }} <br>
            <abbr title="Email">Email:</abbr> <a href="mailto:{{ config('general.email') }}">{{ config('general.email') }}</a>
          </address>
        </div>
      </div>
      <!-- /column -->
