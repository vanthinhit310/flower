...
# php artisan doctrine:convert:mapping --force --from-database annotation lib/ --namespace "JmsEntity\\"
# php artisan doctrine:generate:entities --no-backup --generate-annotations lib/
# php artisan doctrine:generate:entities --no-backup --generate-methods lib/
# php artisan doctrine:schema:validate

php vendor/doctrine/orm/bin/doctrine orm:clear-cache:metadata
php vendor/doctrine/orm/bin/doctrine orm:convert-mapping --force --from-database annotation lib/ --namespace "JmsEntity\\"
php vendor/doctrine/orm/bin/doctrine orm:generate-entities --no-backup --generate-annotations=true lib/ # --update-entities --regenerate-entities
php vendor/doctrine/orm/bin/doctrine orm:generate-entities --no-backup --generate-methods=true lib/
